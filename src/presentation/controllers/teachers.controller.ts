...
import type { CreateTeacherUseCase, GetTeacherUseCase, ListTeachersUseCase, UpdateTeacherUseCase, DeleteTeacherUseCase } from '../../application/use-cases/teachers/index.js'

export class TeachersController {
  constructor(
    private createUseCase: CreateTeacherUseCase,
    private getUseCase: GetTeacherUseCase,
    private listUseCase: ListTeachersUseCase,
